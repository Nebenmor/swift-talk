...
class App {
  ...
  private initializeRoutes(): void {
    // API routes
    this.app.use('/api/auth', (req, res) => res.json({ message: 'Auth routes coming soon' }));
    this.app.use('/api/users', (req, res) => res.json({ message: 'User routes coming soon' }));
    this.app.use('/api/chat', (req, res) => res.json({ message: 'Chat routes coming soon' }));
